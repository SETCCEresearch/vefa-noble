...
//    public static final String OPENPEPPOL_TEST = "acc.edelivery.tech.ec.europa.eu";
    public static final String OPENPEPPOL_PRODUCTION = "generalerds.acc.edelivery.tech.ec.europa.eu";
    public static final String OPENPEPPOL_TEST = "generalerds.acc.edelivery.tech.ec.europa.eu";
