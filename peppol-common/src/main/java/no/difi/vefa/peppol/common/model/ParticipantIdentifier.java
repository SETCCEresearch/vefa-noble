...
import no.difi.vefa.peppol.common.code.NobleIcd;
...
//        populate(Iso6523Icd.valueOfIcd(identifier.substring(0, 4)), identifier.substring(5));
        ...
        populate(new NobleIcd(identifier, null, scheme),identifier);
    }
    ...
    public String urlencoded() {
        try {
            return URLEncoder.encode(
                    String.format("%s::%s", icd.getScheme().getValue(), identifier), "UTF-8");
